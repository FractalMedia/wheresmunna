...
cmd:text()
cmd:text('Options:')
cmd:option('-imgPath', 'data/mydataset-subset/aligned/PatrickNN.png',
           'Path to aligned image.')
cmd:option('-filterOutput',
           'data/mydataset-subset/aligned/PatrickNN',
           'Output directory.')
...
torch.IntTensor({1, 3, 7, 11, 13, 15,
                 17, 19, 21}):apply(function (i)
